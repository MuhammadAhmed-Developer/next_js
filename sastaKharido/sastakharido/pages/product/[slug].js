 ...
 const onChangePin = (e) =>{
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://s.alicdn.com/@sc04/kf/H311d7fe9e15142e0825654afa3c03b0cF.png_960x960.png"/>
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <div className="flex">
          ...
          <button className="flex ml-12  text-white bg-green-500 border-0 py-3 px-2 md:px-4 focus:outline-none hover:bg-green-600 rounded text-xs">Buy Now</button>
          <button onClick={()=>{addToCart(20 , 1, 499, 'TShirt Wear-the-code', 'Xl' ,'Red')}} className="flex ml-8 text-white bg-green-500 border-0 py-3 px-2 md:px-4 focus:outline-none hover:bg-green-600 rounded text-xs">Add to Cart</button>
        ...
        <div className="pin mt-6 flex space-x-2 text-sm">
          <input onChange={onChangePin} type="text" placeholder='Enter Pin Code' className='px-2 border-2 border-green-200 rounded-md' />
    ...
    {/* // This syntax show if service is Flase and not null then return  */}
         
         {(!service && service !== null) &&  <div className="text-red-500 text-sm mt-2">
           Sorry! We do not Deliverd on this PinCode
          </div>}
     {/* if service is true and not null then return */}
         {(service && service !== null) && <div className="text-green-500 text-sm mt-2">
           Congratulates🎁! This Pin Code is Serviceable
          </div>}
      </div>
    </div>
  </div>
